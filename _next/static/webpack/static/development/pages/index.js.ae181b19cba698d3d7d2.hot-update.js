...
})(["height:50px;width:50px;border-radius:50%;margin-left:20px;box-shadow:0 5px 20px rgba(0,0,0,0.15);cursor:pointer;transition:200ms ease transform;border:0;:hover,:focus,:active{outline:0;transform:scale(1.1);}", ""], function (props) {
...
//# sourceMappingURL=index.js.ae181b19cba698d3d7d2.hot-update.js.map