...
function Home(_ref) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    ...
    /* Break out if the debounced value hasn't changed from the initialValue. */

    if (debouncedValue === initialValue) {
      if (window.ntc) {
        var _alternateColorName = window.ntc.name("#".concat(initialValue))[1];
        setAlternateColorName(_alternateColorName);
      }
    } else if (debouncedValue.length === 6) {
  ...
  function _getColorName() {
    ...
    _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(hex) {
      var _alternateColorName2, response, _ref2, colors, _error;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              if (window.ntc) {
                _alternateColorName2 = window.ntc.name("#".concat(hex))[1];
                setAlternateColorName(_alternateColorName2);
              }
...
//# sourceMappingURL=index.js.3144260c3c8a60b930d2.hot-update.js.map