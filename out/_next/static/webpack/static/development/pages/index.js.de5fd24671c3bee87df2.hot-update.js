...
function Home(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_layouts_LayoutMain__WEBPACK_IMPORTED_MODULE_10__["default"], {
    ...
    color: colorValue && colorValue.isDark() && 'white' || 'black',
    onClick: function onClick() {
      return isValidAlternateColorName && setShowingAlternateColorName(!isShowingAlternateColorName);
    },
    ...
    size: "xxs",
    align: "center",
    opacity: isValidAlternateColorName ? 0 : 1,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 241
    },
...
//# sourceMappingURL=index.js.de5fd24671c3bee87df2.hot-update.js.map